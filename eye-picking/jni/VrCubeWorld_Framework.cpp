...
long Java_org_gearvrf_eyepickingsample_MainActivity_nativeSetAppInterface( JNIEnv *jni, jclass clazz, jobject activity,
...
long Java_org_gearvrf_eyepickingsample_MainActivity2_nativeSetAppInterface( JNIEnv *jni, jclass clazz, jobject activity,
    jstring fromPackageName, jstring commandString, jstring uriString )
{
    // This is called by the java UI thread.
    LOG( "nativeSetAppInterface" );
